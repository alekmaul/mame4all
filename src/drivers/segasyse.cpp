...
INPUT_PORTS_START( transfrm ) /* Used By Transformer */
	...
	PORT_BITX(0x04, IP_ACTIVE_LOW,  IPT_SERVICE, DEF_STR( Service_Mode ), IP_KEY_NONE, IP_JOY_NONE )
...
GAME( 1986, transfrm, 0,        segae, transfrm, 0,        ROT0,  "Sega", "Transformer" )
GAMEX(1986, astrofl,  transfrm, segae, dummy,    0,        ROT0,  "Sega", "Astro Flash (Japan)", GAME_NOT_WORKING ) /* encrypted */

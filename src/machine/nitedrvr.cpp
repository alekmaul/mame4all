...
WRITE_HANDLER( nitedrvr_out1_w )
{
	...
	/* Invert video */
	palette_change_color(1,0x00,0x00,0x00); /* BLACK */
	palette_change_color(0,0xff,0xff,0xff); /* WHITE */
...
void nitedrvr_crash_toggle(int dummy)
{
	...
	{
	    /* Normal video */
	    palette_change_color(0,0x00,0x00,0x00); /* BLACK */
	    palette_change_color(1,0xff,0xff,0xff); /* WHITE */
	}
	//memset(dirtybuffer,1,videoram_size);
    }
}

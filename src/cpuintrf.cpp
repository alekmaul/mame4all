...
#endif
#if (HAS_FAME)
	CPU0(FAME,   fame, 8, -1,1.00,fame_INT_NONE,  -1,			   -1,			   24bew, 0,24,BE,2,10,24BEW),
#endif
#if (HAS_M68010)
	...
	if (num != INT_TYPE_NONE(cpunum))
	{
		...
		else
		{
			...
			case CPU_FAME:
				switch (num)
				{
				case fame_IRQ_1: 	irq_line = 1; break;
				case fame_IRQ_2: 	irq_line = 2; break;
				case fame_IRQ_3: 	irq_line = 3; break;
				case fame_IRQ_4: 	irq_line = 4; break;
				case fame_IRQ_5: 	irq_line = 5; break;
				case fame_IRQ_6: 	irq_line = 6; break;
				case fame_IRQ_7: 	irq_line = 7; break;
				}
				/* until now only auto vector interrupts supported */
				num = fame_INT_ACK_AUTOVECTOR;
				break;
#endif
#if (HAS_M68010)
			case CPU_M68010:
